								...
								<ul>
									...
									<li>
										...
										<el-checkbox-group v-model="params.regActivityArr">
												<el-checkbox :label="selectDataa.id" :key="selectDataa.id">{{selectDataa.label}}</el-checkbox>
										</el-checkbox-group>
									</li>
								</ul>
							</el-form>
							<el-button type="primary" @click="submitForm('params')" round>NEXT STEP</el-button>
							<p><span @click="$router.push('/sunfin/pagetali')">Create password</span><span style="float: right;" @click="$router.push('/sunfin/pageta')">Register</span></p>
						</div>
